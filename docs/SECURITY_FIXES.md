...
**Action Required:** The previously exposed API key (`AIzaSyBbUbzsZYbG7IhB9APCtIM6Kn2qDQ0-8mQ`) should be **rotated immediately** in the Google Cloud Console, as it was committed to git history.
