...
const OCRServiceTest = {
   ...
   */
  async testGoogleCloudVisionIntegration(imageUri) {
    ...
    try {
      ...
      if (result) {
        ...
        testResult.isValid = OCRService.validateExtraction(result);
      }
   ...
   */
  async testPatternMatchingFallback(sampleText) {
    ...
    try {
      ...
      const testResult = {
        ...
        data: result,
        quality: quality,
        isValid: OCRService.validateExtraction(result),
        timestamp: new Date().toISOString(),
      };
