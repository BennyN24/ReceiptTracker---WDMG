...
type PasscodeMode = 'set' | 'verify' | 'change';
...
const SecuritySettingsScreen: React.FC = () => {
  ...
  const [passcodeMode, setPasscodeMode] = useState<PasscodeMode>('set');
  ...
  const handleChangePasscode = useCallback(async (): Promise<void> => {
    try {
  ...
  const handleRemovePasscode = (): void => {
    Alert.alert(
      'Remove Passcode',
